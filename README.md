...
Most specifically, we wrap the return of the function we are testing and the component we are using as expected result. As they have matching types, everything perfectly works.<br />
